...
public class ConfigUtil {
    private static final String APP_NAME = "com.yuwell.aiom";
    private static final String TRACK_ID = "trackID";
    private static final String FT_ORIENT = "ftOrient";
    private static final String ACTVITE = "active";
    ...
    public static void setActive(Context context, boolean bIsActive){
        if (context == null) {
            return;
        }
    ...
    public static boolean getActive(Context context){
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(APP_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(ACTVITE, false);
    }
}
